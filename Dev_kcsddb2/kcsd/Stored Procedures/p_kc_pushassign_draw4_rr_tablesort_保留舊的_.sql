-- ==========================================================================================
-- 03/06/07 KC: modify from draw2_rr_table
--		由 table tmpnopv2抓case, 依 sort及餘額 平均分給法務
-- 07/16/06 KC: 由 table tmpnopv2抓case, 依餘額平均分給法務
...
-- ==========================================================================================
CREATE  PROCEDURE [kcsd].[p_kc_pushassign_draw4_rr_tablesort(保留舊的)]
...
-- pusher_code here is kc_push_sort
DECLARE	cursor_pusher_draw	CURSOR
FOR	SELECT	t.kc_case_no
	FROM	kcsd.kc_tmpnopv2 t, kc_customerloan c
	WHERE	t.kc_case_no = c.kc_case_no
	ORDER BY t.kc_pusher_code, c.kc_rema_amt DESC, t.kc_case_no
