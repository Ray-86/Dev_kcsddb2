...
-- 11/02/2008 Add unicode support for names
-- KC: add reference
-- =============================================
CREATE                     procedure [kcsd].[p_kc_cpcheck_rule2]
...
BEGIN
	...
	WHERE
		(kc_papa_nameu = @wk_cust_nameu
		AND	kc_mama_nameu = @pm_mate_name)
		OR
		(kc_mama_nameu = @wk_cust_nameu
		AND	kc_papa_nameu = @pm_mate_name)
		OR
		(kc_papa_name1u = @wk_cust_nameu
		AND	kc_mama_name1u = @pm_mate_name)
		OR
		(kc_mama_name1u = @wk_cust_nameu
		AND	kc_papa_name1u = @pm_mate_name)
		OR
		(kc_papa_name2u = @wk_cust_nameu
		AND	kc_mama_name2u = @pm_mate_name)
		OR
		(kc_mama_name2u = @wk_cust_nameu
		AND	kc_papa_name2u = @pm_mate_name)
	-- =============================================
	/* Reference */
	INSERT	kcsd.kc_cpresult
		(kc_cp_no, kc_case_no, kc_cust_type,
	...
	WHERE	(kc_papa_name = @wk_cust_nameu
		AND	kc_mama_name = @pm_mate_name)
		OR
		(kc_mama_name = @wk_cust_nameu
		AND	kc_papa_name = @pm_mate_name)
		OR
		(kc_papa_name1 = @wk_cust_nameu
		AND	kc_mama_name1 = @pm_mate_name)
		OR
		(kc_mama_name1 = @wk_cust_nameu
		AND	kc_papa_name1 = @pm_mate_name)
		OR
		(kc_papa_name2 = @wk_cust_nameu
		AND	kc_mama_name2 = @pm_mate_name)
		OR
		(kc_mama_name2 = @wk_cust_nameu
		AND	kc_papa_name2 = @pm_mate_name)
	...
	AND	(kc_papa_nameu = @wk_cust_nameu
		AND	kc_mama_nameu = @pm_mate_name)
		OR
		(kc_mama_nameu = @wk_cust_nameu
		AND	kc_papa_nameu = @pm_mate_name)
