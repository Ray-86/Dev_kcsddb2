CREATE PROCEDURE [kcsd].[p_kc_convert_law1] @wk_strt_date datetime,@wk_stop_date datetime,@wk_law_code VARCHAR(1),@wk_law_fmt VARCHAR(2)
AS
...
--A.kc_law_date BETWEEN @wk_strt_date AND @wk_end_date AND A.kc_law_code + A.kc_law_fmt = @wk_law_code + @wk_law_fmt
ORDER BY 
