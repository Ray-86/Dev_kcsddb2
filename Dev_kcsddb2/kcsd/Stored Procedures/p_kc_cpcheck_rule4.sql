...
-- KC: add reference
-- =============================================
CREATE                  procedure [kcsd].[p_kc_cpcheck_rule4]
...
WHERE	
	(	kc_papa_nameu = @pm_papa_name
	AND	kc_mama_nameu = @pm_mama_name)
	OR
	(	kc_papa_name1u = @pm_papa_name
	AND	kc_mama_name1u = @pm_mama_name)
	OR
	(	kc_papa_name2u = @pm_papa_name
	AND	kc_mama_name2u = @pm_mama_name)
...
WHERE	(	kc_papa_name = @pm_papa_name
	AND	kc_mama_name = @pm_mama_name)
	OR
	(	kc_papa_name1 = @pm_papa_name
	AND	kc_mama_name1 = @pm_mama_name)
	OR
	(	kc_papa_name2 = @pm_papa_name
	AND	kc_mama_name2 = @pm_mama_name)
...
AND	(	kc_papa_nameu = @pm_papa_name
	AND	kc_mama_nameu = @pm_mama_name)
	OR
	(	kc_papa_name1u = @pm_papa_name
	AND	kc_mama_name1u = @pm_mama_name)
