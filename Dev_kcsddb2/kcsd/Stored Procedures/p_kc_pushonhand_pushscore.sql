...
CREATE PROCEDURE [kcsd].[p_kc_pushonhand_pushscore] @pm_strt_date datetime=NULL, @pm_stop_date datetime=NULL	,@pm_area_code varchar(100)=NULL,@pm_run_code varchar(10)=NULL,@pm_group_code varchar(10)=NULL
AS
